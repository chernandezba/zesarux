...
void realjoystick_clear_actions_array(void)
{
    ...
    //strcpy(realjoystick_actions_array[3].parametros,"editionnamegame.tzx");
...
void realjoystick_set_reset_action_send_action(int indice)
{
    //printf ("pulsada tecl de funcion\n");
...
//izquierda: +12
//derecha: (-12)
z80_int realjoystick_steering_address=0xe5e2;
