...
void menu_hardware_settings(MENU_ITEM_PARAMETERS)
{
    ...
    int retorno_menu;
        ...
        if (MACHINE_IS_SPECTRUM) {
            ...
            else menu_add_item_menu_format(array_menu_hardware_settings,MENU_OPCION_NORMAL,menu_hardware_gunstick,NULL,"[%s] Lightgun",gunstick_texto[lightgun_emulation]);
