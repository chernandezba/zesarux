...
char *bitmap_lowericon_ext_desktop_kartusho[EXT_DESKTOP_BUTTONS_ANCHO]={
    ...
    "wwwwwwwwwwwwwwwwwwwwwwwwww",
    "wxxxxxxxxxxxxxxxxxxxxxxxxw",
    "wxyyyyyxxxxxwxwwwxwxxxxxxw",
    "wxyxxxyxxxxxwxxwxxwxxbbxxw",
    "wxyxxxyxxxxxwxxxxxwxxbbxxw",
    "wxyxxxyxxxxxwxxxxxwxxxxxxw",
    "wxyyyyyxxxxxwxxxxxwxxxxxxw",
    "wxxxxxxxxxxxwxxxxxwxxWWxxw",//10
    "wxxRxxxxxxxxwxxxxxwxxWWxxw",
    "wxxxxxxxxxxxwwwwwwwxxxxxxw",
    "wxxxxxxxxxxxxxxxxxxxxxxxxw",
    "wwwwwwwwwwwwwwwwwwwwwwwwww",
