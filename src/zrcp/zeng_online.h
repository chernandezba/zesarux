...
#define ZENG_ONLINE_PERMISSIONS_ALL_SLAVE (ZENG_ONLINE_PERMISSIONS_GET_SNAPSHOT|ZENG_ONLINE_PERMISSIONS_GET_DISPLAY|ZENG_ONLINE_PERMISSIONS_GET_KEYS|ZENG_ONLINE_PERMISSIONS_SEND_KEYS|ZENG_ONLINE_PERMISSIONS_SEND_MESSAGE)

//Damos casi todos permisos al master, excepto read snapshot y read display
#define ZENG_ONLINE_PERMISSIONS_ALL_MASTER (ZENG_ONLINE_PERMISSIONS_PUT_SNAPSHOT|ZENG_ONLINE_PERMISSIONS_PUT_DISPLAY|ZENG_ONLINE_PERMISSIONS_GET_KEYS|ZENG_ONLINE_PERMISSIONS_SEND_KEYS|ZENG_ONLINE_PERMISSIONS_SEND_MESSAGE)
