...
extern void zxvision_draw_filled_triangle(zxvision_window *w,int color_relleno,int color_aristas,int x1,int y1,int x2,int y2,int x3,int y3,void (*fun_putpixel) (zxvision_window *w,int x,int y,int color));
