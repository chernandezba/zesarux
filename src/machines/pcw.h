...
//2 normales, 4 paletas de 4 colores CGA, 2 modos de 16 colores
#define PCW_TOTAL_PALETTE_COLOURS (PCW_COLORS_IN_MODE0+PCW_COLORS_IN_MODE1+PCW_COLORS_IN_MODE2_3+PCW_COLORS_IN_MODE2_3)
