...
void handle_trap_fs_mdinf(void)
{
    ...
    if (indice_canal>=0 ) {
        ...
        //prueba sectores de MDV files in QLAY format. The files must be exactly 174930 bytes 174930/512->aprox 341
...
{
    if (ql_extension_cpu_turbo_enabled) ql_basext_poll();
