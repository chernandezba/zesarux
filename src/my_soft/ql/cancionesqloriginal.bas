...
10180  IF (zcode>=97 AND zcode<=103) OR (zcode>=65 AND zcode<=71) THEN
10190   zupper=0:IF zcode>=65 AND zcode<=71 THEN zupper=1
10200   znote$=zch$:IF zcode>=97 AND zcode<=103 THEN znote$=CHR$(zcode-32)
