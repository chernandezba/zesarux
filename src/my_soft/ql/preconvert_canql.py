...
def main(path: Path, output_path: Path | None = None) -> None:
    ...
    output.extend([
        ...
        "11055  IF zxturbo THEN IF zshow THEN CPU_TURBO 0",
        "11060  AT 0,0:PAPER 7:INK 0:OVER 0:FLASH 0",
        "11065  IF zshow=0 THEN PRINT \"              \";:IF zxturbo THEN CPU_TURBO 1",
        ...
        "11240 DATA 16890,22,8320,19679,3854,28672,20085,17232,21855,21589,21058,20224,0,0",
    ])
