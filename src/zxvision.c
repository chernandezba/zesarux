...
/*
    ...
    */
    ...
    for (buscar_cerca = 0; buscar_cerca < 5; buscar_cerca++) {
        ...
        for (y = yinicial + ZXVISION_OFFSET_ICONOS_REPETIR_POSICION * buscar_cerca;
             y < yfinal; y += ZXVISION_SEPARACION_ICONOS_AL_ORDENAR) {
            for (x = xinicial + ZXVISION_OFFSET_ICONOS_REPETIR_POSICION * buscar_cerca;
                 x < xfinal; x += ZXVISION_SEPARACION_ICONOS_AL_ORDENAR) {
    ...
    debug_printf(VERBOSE_DEBUG,
                 "zxvision_get_next_free_icon_position: No free space. Fallback to initial position %d %d", xinicial,
                 yinicial);
    *p_x = xinicial;
    *p_y = yinicial;
}
...
void zxvision_check_all_configurable_icons_positions(void) {
    ...
    for (i = 0; i < MAX_ZXDESKTOP_CONFIGURABLE_ICONS; i++) {
        if (zxdesktop_configurable_icons_list[i].status == ZXDESKTOP_CUSTOM_ICON_EXISTS) {
            ...
            if (!zxvision_if_configurable_icon_on_valid_position(x, y)) {
                debug_printf(VERBOSE_DEBUG, "Relocate icon %d (%s) because it is on an invalid position %d,%d", i,
                             zxdesktop_configurable_icons_list[i].text_icon, x, y);
...
int zxvision_add_configurable_icon(int indice_funcion) {
    ...
    for (i = 0; i < MAX_ZXDESKTOP_CONFIGURABLE_ICONS; i++) {
        if (zxdesktop_configurable_icons_list[i].status == ZXDESKTOP_CUSTOM_ICON_NOT_EXISTS) {
            ...
            strcpy(zxdesktop_configurable_icons_list[i].text_icon,
...
void create_default_zxdesktop_configurable_icons(void) {
    ...
    if (!zxdesktop_configurable_icons_enabled_and_visible()) {
        debug_printf(VERBOSE_INFO,
                     "Do not create default icons because icons on zx desktop are disabled or zx desktop disabled");
        return;
    }
...
estilos_gui definiciones_estilos_gui[ESTILOS_GUI] = {
        ...
        {1, "ZEsarUX Plus",    AMIGAOS_COLOUR_blue,      ZESARUX_PLUS_COLOUR_WHITE,
                                                               0, 1, 1, 0,        //No mostrar cursor,mostrar recuadro,mostrar rainbow
                                                                           5 +
                                                                           8,     0,        //Colores para opcion seleccionada
                AMIGAOS_COLOUR_blue,      AMIGAOS_COLOUR_red,
                                                              5 +
                                                              8,                                           AMIGAOS_COLOUR_red,    //Colores para opcion no disponible
        ...
        {0, "ZXSpectr", 1, 6,
                                                              1, 1, 0, 0,        //Mostrar cursor >, mostrar recuadro, no mostrar rainbow
                                                                          1 +
8, 6,        //Colores para opcion seleccionada
...
8, 0,        //Colores para opcion seleccionada
        ...
        {0, "CPC", 1, 6 + 8,
                                                               0, 1, 1, 0,          //No mostrar cursor,mostrar recuadro,mostrar rainbow
                                                                           6 +
8, 1,            //Colores para opcion seleccionada
        ...
        {1, "MSX",             VDP_9918_INDEX_FIRST_COLOR + 4, VDP_9918_INDEX_FIRST_COLOR + 15,
                                                                  0, 1, 0, 0,          //No mostrar cursor,mostrar recuadro,no mostrar rainbow
                                                                              VDP_9918_INDEX_FIRST_COLOR + 15,
                                                 VDP_9918_INDEX_FIRST_COLOR +
                                                 4,            //Colores para opcion seleccionada
                                                                           VDP_9918_INDEX_FIRST_COLOR + 4,
VDP_9918_INDEX_FIRST_COLOR + 6, VDP_9918_INDEX_FIRST_COLOR + 15, VDP_9918_INDEX_FIRST_COLOR +
                                                                 6,        //Colores para opcion no disponible

                                            VDP_9918_INDEX_FIRST_COLOR + 15,
VDP_9918_INDEX_FIRST_COLOR + 4,            //Colores para el titulo ventana
                VDP_9918_INDEX_FIRST_COLOR + 15,              //Color recuadro
                   VDP_9918_INDEX_FIRST_COLOR + 4,
                VDP_9918_INDEX_FIRST_COLOR + 15,            //Colores para el titulo ventana inactiva
...
8, 0,          //Colores para opcion seleccionada
        ...
        {0, "ZX80/81",      7 + 8,                    0,
                                                               1, 1, 0, 1,          //Mostrar cursor >, mostrar recuadro, no mostrar rainbow, solo mayusculas
                                                                           0,     7 +
                                                                                  8,          //Colores para opcion seleccionada
                7 + 8,                           0,           0,                                       7 +
                                                                                                       8,      //Colores para opcion no disponible
        ...
        {1, "AmigaOS",         AMIGAOS_COLOUR_blue,   7 + 8,
                ...
                7 + 8,              //Color recuadro
                7 +
                8,                          AMIGAOS_COLOUR_inactive_title_ink,            //Colores para el titulo ventana inactiva
                ...
                2 +
                8, //color de aviso. Seria AMIGAOS_COLOUR_red pero las franjas de volumen usan un formato $$ que solo permite color entre 0-15
                colores_franja_speccy_brillo, colores_franja_speccy_oscuro,
                -1, //si texto inverso solo cambia color tinta
                0, //rellenar titulo
                char_set_amigaos,
        ...
        {1, "RetroMac",        RETROMAC_COLOUR_paper, 0,
                                                               0, 1, 0, 0,        //No mostrar cursor,mostrar recuadro,mostrar rainbow
                RETROMAC_COLOUR_selected_paper,                                   7 +
                                                                                  8,        //Colores para opcion seleccionada
        ...
        {1, "RiscOS",       7 + 8,                       RISCOS_COLOUR_DARKBLUE,
                                                               0, 1, 0, 0,        //No mostrar cursor,mostrar recuadro,mostrar rainbow
                RISCOS_COLOUR_DARKBLUE,                                           7 +
                                                                                  8,        //Colores para opcion seleccionada
                7 +
                8,                        RISCOS_COLOUR_DARKBLUE,          RISCOS_COLOUR_DARKBLUE,         RISCOS_COLOUR_RED,    //Colores para opcion no disponible
...
void
menu_debug_hexdump_with_ascii(char *dumpmemoria, menu_z80_moto_int dir_leida, int bytes_por_linea, z80_byte valor_xor);
...
*/
void putchar_menu_overlay_parpadeo_cache_or_not(int x, int y, z80_byte caracter, int tinta, int papel, int parpadeo,
                                                int use_cache_mismo_caracter) {
...
int zxvision_if_lower_button_switch_zxdesktop_enabled(void) {
    ...
    if (si_complete_video_driver() && scr_driver_can_ext_desktop() &&
        ...
        mouse_menu_disabled.v == 0 && kempston_mouse_emulation.v == 0)
        return 1;
    else return 0;
}
...
void menu_put_switch_zxdesktop_footer(void) {
    ...
    if (zxvision_if_lower_button_switch_zxdesktop_visible()) {
        ...
        if (caracter_ampliar_ancho != ' ')
            scr_putchar_footer_comun_zoom(caracter_ampliar_ancho, xorigen, yorigen, ESTILO_GUI_PAPEL_NORMAL,
                                          ESTILO_GUI_TINTA_NORMAL);

        if (caracter_reducir_ancho != ' ')
            scr_putchar_footer_comun_zoom(caracter_reducir_ancho, xorigen, yorigen + 1, ESTILO_GUI_PAPEL_NORMAL,
                                          ESTILO_GUI_TINTA_NORMAL);

        if (caracter_ampliar_alto != ' ')
            scr_putchar_footer_comun_zoom(caracter_ampliar_alto, xorigen - 1, yorigen + 1, ESTILO_GUI_PAPEL_NORMAL,
                                          ESTILO_GUI_TINTA_NORMAL);

        if (caracter_reducir_alto != ' ')
            scr_putchar_footer_comun_zoom(caracter_reducir_alto, xorigen - 1, yorigen, ESTILO_GUI_PAPEL_NORMAL,
                                          ESTILO_GUI_TINTA_NORMAL);
...
void zxdesktop_switchdesktop_timer_event(void) {
    ...
    if (previous_switchzxdesktop_timer_event_mouse_x != mouse_x ||
...
void menu_footer_f5_menu(void) {
    ...
    if (menu_si_mostrar_footer_f5_menu()) {
        ...
        menu_putstring_footer(0, WINDOW_FOOTER_ELEMENT_Y_F5MENU, "                                ", WINDOW_FOOTER_INK,
                              WINDOW_FOOTER_PAPER);
...
void menu_footer_zesarux_emulator(void) {
    ...
    if (menu_si_mostrar_footer_f5_menu()) {
        ...
        menu_putstring_footer(0, WINDOW_FOOTER_ELEMENT_Y_ZESARUX_EMULATOR, "ZEsarUX emulator v."EMULATOR_VERSION,
                              WINDOW_FOOTER_INK, WINDOW_FOOTER_PAPER);
    }
...
void menu_clear_footer(void) {
    ...
    if (si_complete_video_driver()) {
        ...
        int yinicial =
                screen_get_window_size_height_no_zoom_border_en() + screen_get_ext_desktop_height_no_zoom() - alto;
        ...
        if (MACHINE_IS_QL) {
            //Pegado a la derecha casi, dejando espacio a la derecha del todo para los botones de switch zxdesktop
            xlogo = zoom_x *
                    (QL_DISPLAY_WIDTH + (QL_LEFT_BORDER_NO_ZOOM * 2) * border_enabled.v - ZESARUX_ASCII_LOGO_ANCHO -
                     8 * 3);
        ...
        if (margenx_izq > 0) {
            ...
            if (gris <= umbral_marco) {
                debug_printf(VERBOSE_DEBUG,
                             "Drawing frame around footer logo becase background colour intensity is less than %d%%",
                             umbral_marco);
                color_marco = 'w';
            }
            ...
            screen_put_asciibitmap_generic(&zesarux_ascii_logo_footer[1], NULL, xlogo, yinicial,
                                           ZESARUX_ASCII_LOGO_ANCHO, 24, 0, footer_logo_putpixel, zoom_logo, 0);
        }
...
void redraw_footer_continue(void) {
    ...
    for (y = 0; y < WINDOW_FOOTER_LINES; y++) {
        for (x = 0; x < WINDOW_FOOTER_COLUMNS; x++, pos_array++) {
            ...
            if (menu_multitarea && parpadeo && estado_parpadeo.v)
                caracter = ' '; //si hay parpadeo y toca, meter espacio tal cual (se oculta)
...
void menu_draw_ext_desktop_putpixel_bitmap_icon_text(z80_int *destino GCC_UNUSED, int x, int y, int ancho GCC_UNUSED,
...
void menu_ext_desktop_buttons_get_geometry(int *p_ancho_boton, int *p_alto_boton, int *p_total_botones,
                                           int *p_inicio_botones, int *p_xfinal_botones) {
...
//ancho, alto boton
//xfinal_botones: posicion X mas a la derecha del ultimo boton
void menu_ext_desktop_lower_icons_get_geometry(int *p_ancho_boton, int *p_alto_boton, int *p_total_botones,
                                               int *p_xinicio_botones, int *p_xfinal_botones, int *p_yinicio_botones) {
...
void
menu_draw_ext_desktop_recuadro_button(int xinicio, int yinicio, int ancho_boton, int alto_boton, int color_recuadro) {
  ...
  --------------------------------
	...
	*/
    ...
    if (numero_boton < total_botones) {
        ...
        screen_put_asciibitmap_generic(puntero_bitmap, NULL, destino_x, destino_y, ZESARUX_ASCII_LOGO_ANCHO,
                                       ZESARUX_ASCII_LOGO_ALTO, 0, menu_draw_ext_desktop_putpixel_bitmap, nivel_zoom,
                                       0);
    }
}
    ...
    if (puntero_bitmap == bitmap_lowericon_ext_desktop_plus3_flp_active) {
        ...
        if (dskplusthree_emulation.v && pd765_motor_status) {
            ...
            if (cf2_floppy_icon_is_saving) {
                if (lowericon_cf2_floppy_frame == 0)
                    puntero_bitmap = bitmap_lowericon_ext_desktop_plus3_flp_active_save_framezero;
                if (lowericon_cf2_floppy_frame == 1)
                    puntero_bitmap = bitmap_lowericon_ext_desktop_plus3_flp_active_save_frameone;
                if (lowericon_cf2_floppy_frame == 2)
                    puntero_bitmap = bitmap_lowericon_ext_desktop_plus3_flp_active_save_frametwo;
                if (lowericon_cf2_floppy_frame == 3)
                    puntero_bitmap = bitmap_lowericon_ext_desktop_plus3_flp_active_save_framethree;
            } else {
                if (lowericon_cf2_floppy_frame == 0)
                    puntero_bitmap = bitmap_lowericon_ext_desktop_plus3_flp_active_framezero;
                if (lowericon_cf2_floppy_frame == 1)
                    puntero_bitmap = bitmap_lowericon_ext_desktop_plus3_flp_active_frameone;
                if (lowericon_cf2_floppy_frame == 2)
                    puntero_bitmap = bitmap_lowericon_ext_desktop_plus3_flp_active_frametwo;
                if (lowericon_cf2_floppy_frame == 3)
                    puntero_bitmap = bitmap_lowericon_ext_desktop_plus3_flp_active_framethree;
            }
            inverso = 0;
        }
    }
...
void menu_ext_desktop_draw_configurable_icon(int index_icon, int pulsado) {
    ...
    if (pulsado || menu_ext_desktop_transparent_configurable_icons.v == 0 ||
        menu_pressed_zxdesktop_configurable_icon_which == index_icon) {
        ...
        menu_draw_ext_desktop_one_configurable_icon_background(x, y, menu_get_ext_desktop_icons_size(),
                                                               menu_get_ext_desktop_icons_size(), color);
    }
        ...
        if (geometry_name[0]) {
            ...
            */
            ...
            if (buscar_ventana_abierta != NULL) {
                ...
                menu_draw_ext_desktop_one_configurable_icon_background(x, y_app_abierta,
                                                                       menu_get_ext_desktop_icons_size(),
    ...
    if (menu_ext_desktop_configurable_icons_text_background.v) {
        ...
        menu_draw_ext_desktop_one_configurable_icon_background(x, y_texto_icono,
                                                               (CHARSET_ICONS_ANCHO + 1) * longitud_texto * zoom_x *
                                                               menu_gui_zoom,
                                                               CHARSET_ICONS_ALTO * zoom_y * menu_gui_zoom,
                                                               ESTILO_GUI_PAPEL_NORMAL);
    }
    ...
    for (i = 0; i < MAX_ZXDESKTOP_CONFIGURABLE_ICONS; i++) {
        if (zxdesktop_configurable_icons_list[i].status == ZXDESKTOP_CUSTOM_ICON_EXISTS) {
            ...
            if (posicion_x >= x && posicion_x < x + tamanyo &&
                posicion_y >= y && posicion_y < y + tamanyo)
                return i;
        }
    }
...
void zxdesktop_draw_scrfile_load(void) {
    ...
    if (zxdesktop_cache_scrfile == NULL) {
        ...
        if (zxdesktop_cache_scrfile == NULL || zxdesktop_cache_scrfile_invertflash == NULL)
            cpu_panic("Can not allocate cache memory for scr file");
    }
...
void menu_draw_ext_desktop_background(int xstart_zxdesktop) {
    ...
    */
    ...
    int grueso_lineas_rainbow =
            8 * zoom_x * menu_gui_zoom; //Para que coincida el color con rainbow de titulo de ventanas
        ...
        for (x = xinicio; x < xfinal; x++) {
            ...
            if (mostrar_scrfile) {
                ...
                switch (menu_ext_desktop_fill) {
                    ...
                    case 1:
                    case 2:
                        indice_color = ((contador_color_rainbow / grueso_lineas_rainbow) +
                                        menu_ext_desktop_fill_rainbow_counter) % total_colores_rainbow;
...
void menu_get_cpu_use_perc(void) {
    ...
    if (menu_cpu_use_seconds_antes != 0) {
        ...
        debug_printf(VERBOSE_PARANOID, "sec now: %ld before: %ld cpu now: %ld before: %ld", menu_cpu_use_seconds_ahora,
                     menu_cpu_use_seconds_antes,
...
void menu_draw_cpu_use(void) {
    ...
    if (top_speed_timer.v) {
        ...
        menu_putstring_footer(WINDOW_FOOTER_ELEMENT_X_CPU_USE, WINDOW_FOOTER_ELEMENT_Y_CPU_USE, "TOPSPEED",
                              ESTILO_GUI_COLOR_AVISO, WINDOW_FOOTER_PAPER);
        return;
    }
...
void normal_overlay_texto_menu(void) {
    ...
    normal_overlay_time_total_drawing_overlay = timer_stats_diference_time(&zxvision_time_total_antes,
                                                                           &zxvision_time_total_despues);
...
int menu_es_prefijo_utf(z80_byte caracter) {
    if (caracter == 0xD0 || caracter == 0xD1 || caracter == 0xC2 || caracter == 0xC3 || caracter == 0xC9 ||
        caracter == 0xCE)
        return 1;
    else return 0;
}
...
void menu_retorna_colores_linea_opcion(int indice, int opcion_actual, int opcion_activada, int *papel_orig,
                                       int *tinta_orig) {
    int papel, tinta;
...
void menu_escribe_linea_opcion_zxvision(zxvision_window *ventana, int indice, int opcion_actual, int opcion_activada,
                                        char *texto_entrada, int tiene_submenu) {
...
//opcion_actual indica que numero de linea es la seleccionada
//opcion activada indica a 1 que esa opcion es seleccionable
void menu_escribe_linea_opcion_tabulado_zxvision(zxvision_window *ventana, int indice, int opcion_actual,
                                                 int opcion_activada, char *texto, int x, int y) {
...
void menu_dibuja_ventana_franja_arcoiris_trozo(int x, int y, int ancho, int franjas) {
    ...
    if (ESTILO_GUI_MUESTRA_RAINBOW) {
        ...
        if (si_complete_video_driver()) {
            ...
            int i;
            for (i = margen; i >= margen - 4; i--)
                putchar_menu_overlay(x + ancho - i, y, ' ', ESTILO_GUI_PAPEL_TITULO, ESTILO_GUI_PAPEL_TITULO);
...
int menu_da_ancho_titulo(char *titulo) {
    ...
    int ancho_total = strlen(titulo) + ancho_boton_cerrar + ancho_franjas_color +
                      margen_adicional; //+1 de margen, para que no se pegue el titulo
...
void menu_dibuja_ventana_boton_background(int x, int y, int ancho, zxvision_window *w) {
    ...
    if (zxvision_window_can_be_backgrounded(w)) {
        if (ventana_tipo_activa) {
            ...
            putchar_menu_overlay(x + zxvision_return_background_button_position(ancho), y,
                                 zxvision_get_character_backgrounded_window(), ESTILO_GUI_TINTA_TITULO,
                                 ESTILO_GUI_PAPEL_TITULO);
        } else {
            ...
            if (menu_hide_background_button_on_inactive.v == 0) {
                ...
                if (w->overlay_function != NULL) {
                    ...
                    putchar_menu_overlay_parpadeo(x + zxvision_return_background_button_position(ancho), y,
                                                  zxvision_get_character_backgrounded_window(),
                                                  ESTILO_GUI_TINTA_TITULO_INACTIVA, ESTILO_GUI_PAPEL_TITULO_INACTIVA,
                                                  1);
                }
            }
        }
...
void menu_dibuja_ventana_botones(void) {
    ...
    if (ventana_tipo_activa) {
        if (cuadrado_activo_resize) {
            ...
            putchar_menu_overlay(x + zxvision_return_minimize_button_position(ancho), y, caracter_minimizar,
                                 ESTILO_GUI_TINTA_TITULO, ESTILO_GUI_PAPEL_TITULO);
            ...
            putchar_menu_overlay(x + zxvision_return_maximize_button_position(ancho), y, caracter_maximizar,
                                 ESTILO_GUI_TINTA_TITULO, ESTILO_GUI_PAPEL_TITULO);
...
void menu_dibuja_ventana(int x, int y, int ancho, int alto, char *titulo_original) {
    ...
    if (!no_dibuja_ventana_muestra_pending_error_message &&
        !zxvision_currently_restoring_windows_on_start)
    ...
    for (i = 0; i < alto - 1; i++) {
        for (j = 0; j < ancho; j++) {
            putchar_menu_overlay_parpadeo_cache_or_not(x + j, y + i + 1, ' ', ESTILO_GUI_TINTA_NORMAL,
                                                       ESTILO_GUI_PAPEL_NORMAL, 0, 0);
        }
    }

    menu_establece_cuadrado(xpixel, ypixel, xderecha, ypixel + altopixel - 1 - menu_char_height,
                            ESTILO_GUI_COLOR_RECUADRO);
...
zxvision_known_window_names zxvision_known_window_names_array[] = {
        {"waveform", menu_audio_new_waveform, bitmap_button_ext_desktop_waveform},
        {"ayregisters", menu_ay_registers, bitmap_button_ext_desktop_audioregisters},
        {"aypiano", menu_ay_pianokeyboard, bitmap_button_ext_desktop_audiopiano},
        {"aysheet", menu_ay_partitura, bitmap_button_ext_desktop_audiosheet},
        {"ayplayer", menu_audio_new_ayplayer, bitmap_button_ext_desktop_ayplayer},
...
char **zxvision_find_icon_for_known_window(char *nombre) {
    ...
    for (i = 0; zxvision_known_window_names_array[i].start != NULL; i++) {
        ...
        if (!strcasecmp(zxvision_known_window_names_array[i].nombre, nombre))
            return zxvision_known_window_names_array[i].bitmap_button;
...
void zxvision_new_window_check_range(int *x, int *y, int *visible_width, int *visible_height) {
    ...
    if (!zxvision_new_window_check_range_aux_x(*x, *visible_width)) {
        ...
        debug_printf(VERBOSE_INFO, "zxvision_new_window: window out of range: %d,%d %dx%d. Adjusting x position", *x,
                     *y, *visible_width, *visible_height);
        *x = 0;
    }

    if (!zxvision_new_window_check_range_aux_x(*x, *visible_width)) {

        debug_printf(VERBOSE_INFO, "zxvision_new_window: window out of range: %d,%d %dx%d. Adjusting visible width", *x,
                     *y, *visible_width, *visible_height);
    ...
    if (!zxvision_new_window_check_range_aux_y(*y, *visible_height)) {
        ...
        debug_printf(VERBOSE_INFO, "zxvision_new_window: window out of range: %d,%d %dx%d. Adjusting y position", *x,
                     *y, *visible_width, *visible_height);
        *y = 0;
    }
    ...
    if (!zxvision_new_window_check_range_aux_y(*y, *visible_height)) {
        ...
        debug_printf(VERBOSE_INFO, "zxvision_new_window: window out of range: %d,%d %dx%d. Adjusting visible height",
...
void zxvision_new_window_check_static_size_range(int *x, int *y, int *visible_width, int *visible_height) {
    ...
    if (
        ...
        debug_printf(VERBOSE_INFO, "zxvision_new_window: window out of range: %d,%d %dx%d", *x, *y, *visible_width,
                     *visible_height);
...
void zxvision_new_window_no_check_range(zxvision_window *w, int x, int y, int visible_width, int visible_height,
                                        int total_width, int total_height, char *title) {
...
void zxvision_new_window(zxvision_window *w, int x, int y, int visible_width, int visible_height, int total_width,
                         int total_height, char *title) {
...
void zxvision_new_window_nocheck_staticsize(zxvision_window *w, int x, int y, int visible_width, int visible_height,
                                            int total_width, int total_height, char *title) {
...
void
zxvision_new_window_gn_cim(zxvision_window *w, int x, int y, int visible_width, int visible_height, int total_width,
                           int total_height,
                           char *title, char *geometry_name, int is_minimized, int is_maximized,
...
//escribe la cadena de texto
void zxvision_scanf_print_string(zxvision_window *ventana, char *string, int offset_string, int max_length_shown, int x,
                                 int y, int pos_cursor_x) {
...
int zxvision_scanf(zxvision_window *ventana, char *string, unsigned int max_length, int max_length_shown, int x, int y,
                   int volver_si_fuera_foco, int volver_si_flecha_abajo) {
...
int zxvision_generic_message_aux_justificar_lineas(char *orig_texto, int longitud, int max_ancho_texto,
                                                   char **buffer_lineas) {
    ...
    do {
        ...
        if (indice_linea == MAX_LINEAS_TOTAL_GENERIC_MESSAGE) {
            ...
            debug_printf(VERBOSE_INFO, "Max lines on menu_generic_message reached (%d)",
                         MAX_LINEAS_TOTAL_GENERIC_MESSAGE);
            //finalizamos bucle
...
void zxvision_generic_message_crea_ventana(zxvision_window *ventana, int xventana, int yventana, int ancho_ventana,
                                           int alto_ventana,
                                           int alto_total_ventana, char *titulo, int resizable, int mostrar_cursor,
                                           int lineas, char **buffer_lineas,
                                           int is_minimized, int is_maximized, int ancho_antes_minimize,
                                           int alto_antes_minimize) {
...
void
zxvision_generic_message_tooltip(char *titulo, int return_after_print_text, int volver_timeout, int tooltip_enabled,
                                 int mostrar_cursor, generic_message_tooltip_return *retorno, int resizable,
                                 const char *texto_format, ...) {
    //Buffer de entrada
    ...
    char *new_buffer_lineas = util_malloc(MAX_LINEAS_TOTAL_GENERIC_MESSAGE * MAX_ANCHO_LINEAS_GENERIC_MESSAGE,
                                          "Can not allocate memory for message");
    ...
    int indice_linea = zxvision_generic_message_aux_justificar_lineas(texto, longitud, max_ancho_texto,
                                                                      punteros_buffer_lineas);
    ...
    zxvision_generic_message_crea_ventana(ventana, xventana, yventana, ancho_ventana, alto_ventana, alto_total_ventana,
                                          titulo, resizable, mostrar_cursor, indice_linea, punteros_buffer_lineas, 0, 0,
    ...
    do {
        ...
        switch (tecla) {
            ...
            case 'c':
                ...
                menu_generic_message_splash("Clipboard",
                                            "Text copied to ZEsarUX clipboard. Go to file utils and press P to paste to a file");
            ...
            */
            ...
            default:
                ...
                if (ancho_ventana != ventana->visible_width) {
                    ...
                    //Controlar maximo
                    if (ancho_linea > MAX_ANCHO_LINEAS_GENERIC_MESSAGE - 2)
                        ancho_linea = MAX_ANCHO_LINEAS_GENERIC_MESSAGE - 2;

                    //Y minimo
                    if (ancho_linea < 5) ancho_linea = 5;

                    indice_linea = zxvision_generic_message_aux_justificar_lineas(texto, longitud, ancho_linea,
                                                                                  punteros_buffer_lineas);
                    ...
                    zxvision_generic_message_crea_ventana(ventana, xventana, yventana, ancho_ventana, alto_ventana,
                                                          alto_total_ventana,
                                                          titulo, resizable, mostrar_cursor, indice_linea,
                                                          punteros_buffer_lineas, is_minimized, is_maximized,
...
void zxvision_draw_vertical_scroll_bar(zxvision_window *w, int estilo_invertido) {
    ...
    menu_ventana_draw_vertical_perc_bar(w, w->x, w->y, w->visible_width, w->visible_height - 1, porcentaje,
                                        estilo_invertido);
}
...
void zxvision_draw_horizontal_scroll_bar(zxvision_window *w, int estilo_invertido) {
    ...
    menu_ventana_draw_horizontal_perc_bar(w, w->x, w->y, effective_width, w->visible_height, porcentaje,
                                          estilo_invertido);
}
...
int zxvision_adjust_cursor_bottom(zxvision_window *ventana) {
    ...
    if (zxvision_cursor_out_view(ventana)) {
        ...
        zxvision_set_cursor_line(ventana, offset_y + ventana->visible_height - 2 - ventana->upper_margin -
...
void
zxvision_copy_contents_on_enlarge(overlay_screen *origen, overlay_screen *destino, int ancho_previo, int alto_previo,
                                  int ancho_final) {
    int x, y;
...
void zxvision_enlarge_common(zxvision_window *w, int ancho_alto, int nueva_dimension) {
    ...
    if (redimensionar) {
        ...
        if (ancho_alto) {
            ...
            debug_printf(VERBOSE_DEBUG, "Reallocate window memory to enlarge width. New total_width: %d",
                         nueva_dimension);
        } else {
            w->total_height = nueva_dimension;
            debug_printf(VERBOSE_DEBUG, "Reallocate window memory to enlarge height. New total_height: %d",
                         nueva_dimension);
        }
...
void zxvision_set_visible_width(zxvision_window *w, int visible_width) {
    ...
    if (w->contents_can_be_enlarged) {
        debug_printf(VERBOSE_DEBUG, "Window set visible width new: %d previous total_width: %d", visible_width,
                     w->total_width);
...
void zxvision_set_visible_height(zxvision_window *w, int visible_height) {
    ...
    if (w->contents_can_be_enlarged) {
        debug_printf(VERBOSE_DEBUG, "Window set visible height new: %d previous total_height: %d", visible_height,
                     w->total_height);
...
void zxvision_set_total_height(zxvision_window *w, int total_height) {
    ...
    if (w->contents_can_be_enlarged) {
        debug_printf(VERBOSE_DEBUG, "Window set total height new: %d previous total_height: %d", total_height,
                     w->total_height);
        ...
        for (x = 0; x < width; x++) {
            ...
            if (!out_of_bonds) {
                ...
                if (!ventana_encima) {
                    putchar_menu_overlay_parpadeo_cache_or_not(xdestination, ydestination,
                                                               ' ', ESTILO_GUI_TINTA_NORMAL,
                                                               w->default_paper/*ESTILO_GUI_PAPEL_NORMAL*/, 0,
                                                               use_cache);
                }
            }
            //printf ("sonda 3\n");
...
void
zxvision_print_string_format(zxvision_window *w, int x, int y, int tinta, int papel, int parpadeo, const char *format,
                             ...) {
...
*/
    ...
    int window_pixel_final_x =
            window_pixel_start_x + ((w->visible_width) - zxvision_get_minus_width_byscrollvbar(w)) * menu_char_width;
    ...
    if (xfinal >= window_pixel_start_x && xfinal < window_pixel_final_x && yfinal >= window_pixel_start_y &&
        yfinal < window_pixel_final_y) {
...
*/
    ...
    int window_pixel_final_x = window_pixel_start_x +
                               ((w->visible_width) - zxvision_get_minus_width_byscrollvbar(w)) * menu_char_width *
                               zoom_x;
    ...
    if (xfinal >= window_pixel_start_x && xfinal < window_pixel_final_x && yfinal >= window_pixel_start_y &&
        ...
        //Chapucilla para evitar que las ventanas en background sobreescriban a las de arriba
        //if (!zxvision_coords_in_front_window(w,xfinal/menu_char_width,yfinal/8)) {
        if (!zxvision_coords_in_superior_windows(w, (xfinal / menu_char_width) / zoom_x,
                                                 (yfinal / menu_char_height) / zoom_y)) {
...
void zxvision_draw_line(zxvision_window *w, int x1, int y1, int x2, int y2, int c,
...
void zxvision_draw_arc(zxvision_window *w, int x1, int y1, int radius_x, int radius_y, int c,
                       void (*fun_putpixel)(zxvision_window *w, int x, int y, int color), int inicio_grados,
                       int limite_grados) {
...
void zxvision_draw_ellipse(zxvision_window *w, int x1, int y1, int radius_x, int radius_y, int c,
                           void (*fun_putpixel)(zxvision_window *w, int x, int y, int color), int limite_grados) {
...
void
zxvision_widgets_draw_speedometer(zxvision_window *ventana, int xcentro_widget, int ycentro_widget, int longitud_linea,
                                  int grados, int color_linea, int color_contorno) {
    ...
    zxvision_draw_line(ventana, xcentro_widget, ycentro_widget, xfinal_linea, yfinal_linea, color_linea,
                       zxvision_putpixel);
...
void zxvision_widgets_draw_speedometer_common(zxvision_window *ventana, int xcentro_widget, int ycentro_widget,
                                              int percentaje, int color_linea, int color_contorno) {
    ...
    zxvision_widgets_draw_speedometer(ventana, xcentro_widget, ycentro_widget, longitud_linea, grados, color_linea,
                                      color_contorno);
...
void
zxvision_draw_filled_rectangle(zxvision_window *ventana, int xinicio, int yinicio, int ancho, int alto, int color) {
...
void zxvision_widgets_erase_speedometer(zxvision_window *ventana, int xcentro_widget, int ycentro_widget) {
    ...
    zxvision_draw_filled_rectangle(ventana,
                                   xcentro_widget - ZXVISION_WIDGET_TYPE_SPEEDOMETER_LINE_LENGTH,
                                   ycentro_widget - ZXVISION_WIDGET_TYPE_SPEEDOMETER_LINE_LENGTH,
                                   ZXVISION_WIDGET_TYPE_SPEEDOMETER_LINE_LENGTH * 2 + 1,
                                   ZXVISION_WIDGET_TYPE_SPEEDOMETER_LINE_LENGTH + 1, ESTILO_GUI_PAPEL_NORMAL);
}

void zxvision_widgets_draw_circle_ellipse(zxvision_window *ventana, int x, int y, int percentaje, int color,
                                          int radio_total_x, int radio_total_y, int concentrico) {
    ...
    if (concentrico) {
        int i;
        for (i = 2; i < 5; i++) {
            zxvision_draw_ellipse(ventana, x, y, radio_porcentaje_x / i, radio_porcentaje_y / i, color,
...
void
zxvision_widgets_draw_curve_common(zxvision_window *ventana, int xinicio_widget, int ycentro_widget, int percentaje,
                                   int color, int longitud_linea) {
    ...
    zxvision_draw_ellipse(ventana, centro_widget, ycentro_widget, radio_porcentaje, radio_porcentaje, color,
                          zxvision_putpixel, 180);
...
void zxvision_widgets_draw_particles(zxvision_window *ventana, int xinicio_widget, int ycentro_widget, int percentaje,
                                     int color, int longitud_linea) {
    ...
    for (vueltas = 0; vueltas < max_vueltas; vueltas++) {
        ...
        for (grados = 0; grados < 360; grados++) {
            ...
            zxvision_putpixel(ventana, x_centro_widget + xplano, ycentro_widget - yplano,
                              color); //es -yplano porque si y es positiva, restamos (hacia arriba, pues el 0 de la y esta arriba del todo)
...
void zxvision_widgets_draw_sierpinsky(zxvision_window *ventana, int xinicio_widget, int yinicio_widget, int percentaje,
                                      int color) {
    ...
    for (i = 0; i < percentaje * 2; i++) {
        ...
        zxvision_putpixel(ventana, xinicio_widget + x, yinicio_widget + y,
                          color); //es -y porque si y es positiva, restamos (hacia arriba, pues el 0 de la y esta arriba del todo)
...
void zxvision_widgets_draw_metter_common_by_shortname(zxvision_window *ventana, int columna_texto, int fila_texto,
                                                      char *short_name, int tipo, int valor_en_vez_de_perc,
                                                      int tinta_texto_descripcion, int papel_texto_descripcion,
                                                      int escribir_espacios) {
    ...
    for (i = 0; i < escribir_espacios; i++) {
        zxvision_print_char_simple(ventana, columna_texto + i, fila_texto, tinta_texto_descripcion,
                                   papel_texto_descripcion, 0, ' ');
    }

    zxvision_print_string(ventana, columna_texto, fila_texto, tinta_texto_descripcion, papel_texto_descripcion, 0,
                          buffer_texto_meters);

    if (tipo == ZXVISION_WIDGET_TYPE_SPEEDOMETER) {
        int longitud_linea = ZXVISION_WIDGET_TYPE_SPEEDOMETER_LINE_LENGTH;

        int yorigen_linea = (fila_texto * menu_char_height) + longitud_linea +
                            menu_char_height * 2;  //menu_char_height*2 para que este dos lineas por debajo del texto
        int xcentro_widget = (columna_texto * menu_char_width) + longitud_linea; //Para ajustarlo por la derecha

        zxvision_widgets_draw_speedometer_common(ventana, xcentro_widget, yorigen_linea, media_cpu_perc, color_pixeles,
                                                 color_pixeles);
    ...
    if (tipo == ZXVISION_WIDGET_TYPE_SPEAKER) {
        ...
        for (y = 0; y < alto; y++) {
            ...
            if (y == 0 || y == alto - 1)
                zxvision_draw_line(ventana, xorig + 1, yorig + y, xorig + ancho - 1, yorig + y, ESTILO_GUI_TINTA_NORMAL,
                                   zxvision_putpixel);
            else
                zxvision_draw_line(ventana, xorig, yorig + y, xorig + ancho, yorig + y, ESTILO_GUI_TINTA_NORMAL,
                                   zxvision_putpixel);
        }

        int ycirculo = (fila_texto * menu_char_height) + (radio_circulo) +
                       menu_char_height * 2;  //menu_char_height*2 para que este dos lineas por debajo del texto
        int xcirculo = (columna_texto * menu_char_width) + radio_circulo;

        zxvision_widgets_draw_circle_ellipse(ventana, xcirculo, ycirculo, media_cpu_perc, color_pixeles,
                                             radio_circulo - 3, radio_circulo - 3, concentrico);
    ...
    if (tipo == ZXVISION_WIDGET_TYPE_CIRCLE || tipo == ZXVISION_WIDGET_TYPE_CIRCLE_CONCEN) {
        ...
        zxvision_widgets_draw_circle_ellipse(ventana, xcirculo, ycirculo, media_cpu_perc, color_pixeles, radio_circulo,
                                             radio_circulo, concentrico);
    ...
    if (tipo == ZXVISION_WIDGET_TYPE_ELLIPSE || tipo == ZXVISION_WIDGET_TYPE_ELLIPSE_CONCEN) {
        ...
        int ycirculo = (fila_texto * menu_char_height) + (radio_circulo_y) +
                       menu_char_height * 2;  //menu_char_height*2 para que este dos lineas por debajo del texto
        int xcirculo = (columna_texto * menu_char_width) + radio_circulo_x;

        zxvision_widgets_draw_circle_ellipse(ventana, xcirculo, ycirculo, media_cpu_perc, color_pixeles,
                                             radio_circulo_x, radio_circulo_y, concentrico);
    ...
    if (tipo == ZXVISION_WIDGET_TYPE_CURVE) {
        ...
        zxvision_widgets_draw_curve_common(ventana, xorigen_widget, yorigen_linea, media_cpu_perc, color_pixeles,
                                           longitud_linea);
    ...
    if (tipo == ZXVISION_WIDGET_TYPE_PARTICLES) {
        ...
        zxvision_widgets_draw_particles(ventana, xorigen_widget, yorigen_linea, media_cpu_perc, color_pixeles,
                                        longitud_linea);
    ...
    if (tipo == ZXVISION_WIDGET_TYPE_SIERPINSKY) {
        ...
        int xorigen_widget = (columna_texto * menu_char_width);
        int yorigen_widget = (fila_texto * menu_char_height) +
                             menu_char_height * 2;  //menu_char_height*2 para que este dos lineas por debajo del texto;
    ...
    if (tipo == ZXVISION_WIDGET_TYPE_VOLUME) {
        zxvision_widgets_draw_volumen_maxmin(ventana, columna_texto, fila_texto, tinta_texto, ESTILO_GUI_PAPEL_NORMAL,
                                             media_cpu_perc, 15);
...
void
zxvision_if_mouse_in_lower_button_enlarge_reduce_zxdesktop_common(int *p_x, int *p_y, int *p_xboton, int *p_yboton) {
...
int zxvision_if_mouse_in_zlogo_or_buttons_desktop(void) {
    ...
    if (screen_ext_desktop_enabled && scr_driver_can_ext_desktop()) {
        ...
        if (menu_zxdesktop_buttons_enabled.v) {
            ...
            menu_ext_desktop_buttons_get_geometry(&ancho_boton, &alto_boton, &total_botones, &xinicio_botones,
                                                  &xfinal_botones);
        ...
        if (menu_zxdesktop_buttons_enabled.v) {
            ...
            menu_ext_desktop_lower_icons_get_geometry(&ancho_boton, &alto_boton, NULL, &xinicio_botones,
                                                      &xfinal_botones, &yinicio_botones);
        ...
        */
        ...
        if (zxvision_si_icono_cerca_de_papelera(configurable_icon_is_being_moved_which, mouse_pixel_x, mouse_pixel_y)) {
            ...
            if (estado_icono == ZXDESKTOP_CUSTOM_ICON_DELETED) {
                ...
                //Cambiarle la posicion que tenia inicial antes de ir a la papelera
                zxvision_set_configurable_icon_position(configurable_icon_is_being_moved_which,
                                                        configurable_icon_is_being_moved_previous_x,
                                                        configurable_icon_is_being_moved_previous_y);
                zxvision_move_configurable_icon_to_trash(configurable_icon_is_being_moved_which);
            }
        }
    }
    ...
    if (configurable_icon_is_being_moved) {
        ...
        if (configurable_icon_is_being_moved_which >= 0) {
            ...
            if (deltax > 10 || deltay > 10) {
                zxvision_set_configurable_icon_position(configurable_icon_is_being_moved_which, mouse_pixel_x,
                                                        mouse_pixel_y);
            } else {
            ...
            if (deltax > 0 || deltay > 0) {
                ...
                if (zxvision_si_icono_cerca_de_papelera(configurable_icon_is_being_moved_which, mouse_pixel_x,
                                                        mouse_pixel_y)) {
...
void zxvision_handle_mouse_events(zxvision_window *w) {
    ...
    if (menu_pressed_shift_left || menu_pressed_shift_right) {
        ...
        if (menu_allow_background_windows && zxvision_current_window != NULL && w->can_be_backgrounded) {
            ...
            */
            ...
            //simular escape
            debug_printf(VERBOSE_DEBUG,
                         "Pressed shift left/right but background is not allowed or window can not be bacgrounded, or window NULL. Simulate close window");
            //mouse_pressed_background_window=1;
    ...
    if (mouse_left && !mouse_is_dragging) {
        ...
        if (si_menu_mouse_en_ventana() && !zxvision_keys_event_not_send_to_machine) {
            ...
            debug_printf(VERBOSE_DEBUG, "Clicked outside window. Events are sent to emulated machine. X=%d Y=%d",
            ...
            ventana_pulsada = zxvision_coords_in_below_windows(zxvision_current_window, absolute_mouse_x,
                                                               absolute_mouse_y);
            ...
            if (last_y_mouse_clicked == 0) {
                if (!mouse_is_double_clicking) {
                    ...
                    if (last_x_mouse_clicked == 0 && menu_hide_close_button.v == 0) {
                        ...
                        putchar_menu_overlay(w->x, w->y, menu_retorna_caracter_cerrar(), ESTILO_GUI_PAPEL_TITULO,
                                             ESTILO_GUI_TINTA_TITULO);
                    }

                    //Si pulsa zona background  window
                    if (last_x_mouse_clicked == zxvision_return_background_button_position(w->visible_width) &&
                        w->can_be_backgrounded && menu_allow_background_windows) {
                        mouse_pressed_background_window = 1;
                        //Mostrar boton background pulsado
                        putchar_menu_overlay(w->x + zxvision_return_background_button_position(w->visible_width), w->y,
                                             zxvision_get_character_backgrounded_window(), ESTILO_GUI_PAPEL_TITULO,
                                             ESTILO_GUI_TINTA_TITULO);
                    }


                    //Si se pulsa en boton minimizar, indicar que se esta pulsando
                    if (last_x_mouse_clicked == zxvision_return_minimize_button_position(w->visible_width) &&
                        menu_hide_minimize_button.v == 0 && w->can_be_resized) {
                        putchar_menu_overlay(w->x + zxvision_return_minimize_button_position(w->visible_width), w->y,
                                             menu_retorna_caracter_minimizar(w), ESTILO_GUI_PAPEL_TITULO,
                                             ESTILO_GUI_TINTA_TITULO);
                    }

                    //Si se pulsa en boton maximizar, indicar que se esta pulsando
                    if (last_x_mouse_clicked == zxvision_return_maximize_button_position(w->visible_width) &&
                        menu_hide_maximize_button.v == 0 && w->can_be_resized) {
                        putchar_menu_overlay(w->x + zxvision_return_maximize_button_position(w->visible_width), w->y,
                                             menu_retorna_caracter_maximizar(w), ESTILO_GUI_PAPEL_TITULO,
                                             ESTILO_GUI_TINTA_TITULO);
                    }
			...
			*/
            ...
            if (zxvision_if_horizontal_scroll_bar(w)) {
                if (last_y_mouse_clicked == w->visible_height - 1) {
                    ...
                    //Zona porcentaje
                    if (last_x_mouse_clicked > posicion_flecha_izquierda &&
                        last_x_mouse_clicked < posicion_flecha_derecha) {
    ...
    if (!mouse_left && mouse_is_clicking && !mouse_is_dragging) {
        ...
        if (si_menu_mouse_en_ventana() && last_y_mouse_clicked == 0) {
            ...
            if (mouse_is_double_clicking) {
                ...
                else if (last_x_mouse_clicked == zxvision_return_maximize_button_position(w->visible_width) &&
                         menu_hide_maximize_button.v == 0) {
        ...
        if (w->can_mouse_send_hotkeys && si_menu_mouse_en_ventana() && last_y_mouse_clicked > 0 &&
            last_y_mouse_clicked < w->visible_height - 1) {
        ...
        if (!zxvision_keys_event_not_send_to_machine) {
            ...
            if (ventana_pulsada != NULL ||
                zxvision_if_mouse_in_zlogo_or_buttons_desktop()  /*&& !zxvision_keys_event_not_send_to_machine*/) {
                debug_printf(VERBOSE_DEBUG,
                             "Clicked inside other window or zlogo. Events are not sent to emulated machine");
                zxvision_keys_event_not_send_to_machine = 1;
                ventana_tipo_activa = 1;
                zxvision_draw_window(w);
                zxvision_draw_window_contents(w);
        ...
        if (zxvision_if_horizontal_scroll_bar(w)) {
            if (last_y_mouse_clicked == w->visible_height - 1) {
                ...
                if (last_x_mouse_clicked > posicion_flecha_izquierda &&
                    ...
                    int offset_to_mult =
                            w->total_width - w->visible_width + 1; //+1 porque se pierde linea derecha por scroll
        ...
        if (zxvision_if_vertical_scroll_bar(w)) {
            if (last_x_mouse_clicked == w->visible_width - 1) {
                ...
                if (last_y_mouse_clicked > posicion_flecha_arriba && last_y_mouse_clicked < posicion_flecha_abajo) {
                    ...
                    int offset_to_mult = w->total_height - w->visible_height +
                                         2; //+2 porque se pierde linea abajo de scroll y titulo
                    //printf ("Multiplicando sobre %d\n",offset_to_mult);
...
void zxvision_simple_progress_window(char *titulo, int (*funcioncond)(zxvision_window *),
                                     void (*funcionprint)(zxvision_window *)) {
    zxvision_window ventana;
    ...
    zxvision_new_window(&ventana, x_ventana, y_ventana, ancho_ventana, alto_ventana, ancho_ventana - 1,
                        alto_ventana - 2, titulo);
...
int si_menu_mouse_en_ventana(void) {
    if (menu_mouse_x >= 0 && menu_mouse_y >= 0 && menu_mouse_x < current_win_ancho &&
        menu_mouse_y < current_win_alto)
        return 1;
    return 0;
}
...
int si_menu_mouse_en_ventana_no_en_scrolls(void) {
    if (menu_mouse_x >= 0 && menu_mouse_y >= 0 && menu_mouse_x < current_win_ancho - 1 &&
        menu_mouse_y < current_win_alto - 1)
        return 1;
    return 0;
}
...
void menu_calculate_mouse_xy_absolute_interface_pixel(int *resultado_x, int *resultado_y) {
    ...
    if (x < 0)
        x -= (menu_char_width * menu_gui_zoom); //posicion entre -7 y -1 y demas, cuenta como -1, -2 al dividir entre 8
...
z80_byte menu_da_todas_teclas_si_reset_mouse_movido(int reset_mouse_movido) {
    ...
    acumulado =
            acumulado & (puerto_65278 | 1) & puerto_65022 & puerto_64510 & puerto_63486 & puerto_61438 & puerto_57342 &
            puerto_49150 & (puerto_32766 | 2) & puerto_especial1 & puerto_especial2 & puerto_especial3 &
            puerto_especial4;
    ...
    if (zxvision_current_window != NULL) {
        if (zxvision_current_window->visible_width != ancho_anterior ||
            zxvision_current_window->visible_height != alto_anterior) {
...
void menu_espera_tecla_timeout_tooltip(void) {
    ...
    do {
        ...
        //printf ("menu_espera_tecla_timeout_tooltip acumulado: %d\n",acumulado);
             ...
             menu_tooltip_counter < TOOLTIP_SECONDS);
...
void zxvision_espera_tecla_condicion_progreso(zxvision_window *w, int (*funcioncond)(zxvision_window *),
                                              void (*funcionprint)(zxvision_window *)) {
...
void menu_espera_no_tecla_con_repeticion(void) {
    ...
    do {
        ...
        if ((acumulado & MENU_PUERTO_TECLADO_NINGUNA) ==
            MENU_PUERTO_TECLADO_NINGUNA)
            menu_reset_counters_tecla_repeticion();

        //printf ("contadores: 1 %d  2 %d\n",menu_contador_teclas_repeticion,menu_segundo_contador_teclas_repeticion);

    } while ((acumulado & MENU_PUERTO_TECLADO_NINGUNA) != MENU_PUERTO_TECLADO_NINGUNA &&
             menu_segundo_contador_teclas_repeticion != 0);
...
int menu_dibuja_menu_stdout(int *opcion_inicial, menu_item *item_seleccionado, menu_item *m, char *titulo) {
    ...
    do {
        ...
        if (!menu_speech_tecla_pulsada) {
            scrstdout_menu_print_speech_macro(
...
void
menu_escribe_opciones_zxvision(zxvision_window *ventana, menu_item *aux, int linea_seleccionada, int max_opciones) {
    ...
    for (i = 0; i < max_opciones;/*i++*/) {
        ...
        if (menu_item_retornar_avanzados(aux)) {
            ...
            if (menu_tabulado) {
                menu_escribe_linea_opcion_tabulado_zxvision(ventana, i, linea_seleccionada, opcion_activada,
                                                            menu_retorna_item_language(aux), aux->menu_tabulado_x,
                                                            aux->menu_tabulado_y);
            } else {
                ...
                if (y_destino >= 0) {
                    ...
                    menu_escribe_linea_opcion_zxvision(ventana, y_destino, linea_seleccionada_destino, opcion_activada,
                                                       menu_retorna_item_language(aux), aux->tiene_submenu);
...
//printf ("despues menu_dibuja_ventana_ret_ancho_titulo\n");
    ...
    if (m->es_menu_tabulado == 0) {
        ...
        zxvision_new_window(&ventana_menu, x, y, ancho_visible, alto_visible,
                            ancho - 1 + 1, alto - 2,
                            titulo);         //hacer de momento igual de ancho que ancho visible para poder usar ultima columna
    ...
    do {
        ...
        while (tecla != 13 && tecla != 32 && tecla != MENU_RETORNO_ESC && tecla != MENU_RETORNO_F1 &&
               tecla != MENU_RETORNO_F2 && tecla != MENU_RETORNO_F10 && tecla != MENU_RETORNO_BACKGROUND &&
               redibuja_ventana == 0 && menu_tooltip_counter < TOOLTIP_SECONDS) {
            ...
            while (tecla == 0 && redibuja_ventana == 0 && menu_tooltip_counter < TOOLTIP_SECONDS) {
                ...
                if (m->es_menu_tabulado == 0) {
                    if (menu_dibuja_menu_adjust_last_column(ventana, ancho, alto)) {
                        ...
                        int i;
                        for (i = 0; i < ventana->total_height; i++)
                            zxvision_print_string_defaults_fillspc(ventana, 0, i, "");
                    ...
                    if (si_menu_mouse_en_ventana()) {
                        ...
                        if (menu_mouse_y > 0 && menu_mouse_y < current_win_alto - 1) {
                            ...
                            if (m->es_menu_tabulado == 0) {
                                ...
                                buscar_tabulado = menu_retorna_item_tabulado_xy(m, posicion_raton_x, posicion_raton_y,
                                                                                &linea_buscada);
                ...
                if (menu_mouse_x == current_win_ancho - 1 || menu_mouse_y == 0 ||
                    menu_mouse_y == current_win_alto - 1)
                    mouse_en_zona_opciones = 0;
            ...
            switch (tecla) {
                ...
                case 24:
                    ...
                    if ((*opcion_inicial) - lineas_mover_pgup_dn < 0) {
                        lineas_mover_pgup_dn =
                                (*opcion_inicial) - 1; //el -1 final es por tener en cuenta el separador de siempre
                    }
                    ...
                    for (conta_mover_pgup_dn = 0; conta_mover_pgup_dn < lineas_mover_pgup_dn; conta_mover_pgup_dn++)
                        (*opcion_inicial) = menu_dibuja_menu_cursor_arriba_common((*opcion_inicial), max_opciones, m);
                ...
                case 25:
                    ...
                    if ((*opcion_inicial) + lineas_mover_pgup_dn >= max_opciones) {
                        lineas_mover_pgup_dn = max_opciones - (*opcion_inicial) - 1 -
                                               1; //el -1 final es por tener en cuenta el separador de siempre
                    }
            ...
            if ((tecla >= 'a' && tecla <= 'z') || (tecla >= 'A' && tecla <= 'Z')) {
                ...
                if (entrada_atajo != -1) {
                    ...
                    if (sel_activo != NULL) {
                        ...
                        if (sel_activo() == 0) {
                            debug_printf(VERBOSE_DEBUG, "Shortcut found at entry number %d but entry disabled",
                                         (*opcion_inicial));
                            tecla = 0;
                        }
                    }
...
void menu_add_item_menu_common_defaults(menu_item *m, int tipo_opcion, t_menu_funcion menu_funcion,
                                        t_menu_funcion_activo menu_funcion_activo) {
    ////
...
void menu_add_item_menu_inicial(menu_item **p, char *texto, int tipo_opcion, t_menu_funcion menu_funcion,
                                t_menu_funcion_activo menu_funcion_activo) {
...
void menu_add_item_menu(menu_item *m, char *texto, int tipo_opcion, t_menu_funcion menu_funcion,
                        t_menu_funcion_activo menu_funcion_activo) {
...
//Agregar un item al menu
//Parametros: puntero de menu_item inicial. texto con formato
void menu_add_item_menu_format(menu_item *m, int tipo_opcion, t_menu_funcion menu_funcion,
                               t_menu_funcion_activo menu_funcion_activo, const char *format, ...) {
    char buffer[100];
    va_list args;
    va_start(args, format);
    vsprintf(buffer, format, args);
...
void menu_add_item_menu_en_es_ca(menu_item *m, int tipo_opcion, t_menu_funcion menu_funcion,
                                 t_menu_funcion_activo menu_funcion_activo,
...
void menu_add_item_menu_en_es_ca_inicial(menu_item **m, int tipo_opcion, t_menu_funcion menu_funcion,
                                         t_menu_funcion_activo menu_funcion_activo,
                                         char *english, char *spanish, char *catalan) {
...
void menu_add_item_menu_inicial_format(menu_item **p, int tipo_opcion, t_menu_funcion menu_funcion,
                                       t_menu_funcion_activo menu_funcion_activo, const char *format, ...) {
    char buffer[100];
    va_list args;
    va_start(args, format);
...
void menu_string_volumen(char *texto, z80_byte registro_volumen, int indice_decae) {
    if ((registro_volumen & 16) != 0) sprintf(texto, "ENV            ");
        ...
        if (indice_decae >= 0 && indice_decae <= 14 && indice_decae >= registro_volumen)
            texto[indice_decae + indicado_rojo * 3] = '>';
...
void menu_uncompress_zip_progress(char *zip_file, char *dest_dir) {
    ...
    zxvision_simple_progress_window("Uncompressing", menu_uncompress_zip_progress_cond,
                                    menu_uncompress_zip_progress_print);
...
int menu_generic_message_cursor_abajo_mostrar_cursor(int primera_linea, int alto_ventana, int indice_linea,
                                                     int mostrar_cursor, int *linea_cursor) {
    if (mostrar_cursor) {
...
void menu_ventana_draw_horizontal_perc_bar(zxvision_window *w, int x, int y, int ancho, int alto, int porcentaje,
                                           int estilo_invertido) {
    ...
    menu_ventana_draw_perc_bar_aux(w, xbase - 1, y + alto - 1, zxvision_retorna_caracter_flecha_izquierda(),
                                   tinta_boton_arriba, papel_boton_arriba);
    menu_ventana_draw_perc_bar_aux(w, xbase + ancho - 3, y + alto - 1, zxvision_retorna_caracter_flecha_derecha(),
                                   tinta_boton_abajo, papel_boton_abajo);
    ...
    int i;
    for (i = 0; i < ancho - 3; i++)
        menu_ventana_draw_perc_bar_aux(w, xbase + i, y + alto - 1, caracter_barra, tinta_barra, papel_barra);


    int sumarancho = ((ancho - 4) * porcentaje) / 100;

    menu_ventana_draw_perc_bar_aux(w, xbase + sumarancho, y + alto - 1, '*', ESTILO_GUI_PAPEL_NORMAL,
                                   ESTILO_GUI_TINTA_NORMAL);
}
...
//2: invertir color boton abajo
//3: invertir color barra
void menu_ventana_draw_vertical_perc_bar(zxvision_window *w, int x, int y, int ancho, int alto, int porcentaje,
                                         int estilo_invertido) {
    if (porcentaje < 0) porcentaje = 0;
    if (porcentaje > 100) porcentaje = 100;
    ...
    menu_ventana_draw_perc_bar_aux(w, x + ancho - 1, ybase - 1, zxvision_retorna_caracter_flecha_arriba(),
                                   tinta_boton_arriba, papel_boton_arriba);

    //putchar_menu_overlay(x+ancho-1,ybase+alto-3,'v',tinta_boton_abajo,papel_boton_abajo);
    menu_ventana_draw_perc_bar_aux(w, x + ancho - 1, ybase + alto - 3, zxvision_retorna_caracter_flecha_abajo(),
                                   tinta_boton_abajo, papel_boton_abajo);
    ...
    int i;
    for (i = 0; i < alto - 3; i++)
        menu_ventana_draw_perc_bar_aux(w, x + ancho - 1, ybase + i, caracter_barra, tinta_barra, papel_barra);


    int sumaralto = ((alto - 4) * porcentaje) / 100;
    menu_ventana_draw_perc_bar_aux(w, x + ancho - 1, ybase + sumaralto, '*', ESTILO_GUI_PAPEL_NORMAL,
                                   ESTILO_GUI_TINTA_NORMAL);
}
...
#define MAX_LINEAS_SPLASH 24
        ...
        for (i = 0; i < indice_linea && y < 24; i++) {
            debug_printf(VERBOSE_DEBUG, "line %d y: %d length: %d contents: -%s-", i, y, strlen(buffer_lineas[i]),
                         buffer_lineas[i]);
...
int menu_confirm_yesno_texto(char *texto_ventana, char *texto_interior) {
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_confirm_yes_no, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&confirm_yes_no_opcion_seleccionada, &item_seleccionado,
                                        array_menu_confirm_yes_no, texto_ventana);
...
int menu_simple_two_choices(char *texto_ventana, char *texto_interior, char *opcion1, char *opcion2) {
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_simple_two_choices, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&simple_two_choices_opcion_seleccionada, &item_seleccionado,
                                        array_menu_simple_two_choices, texto_ventana);
...
int menu_simple_three_choices(char *texto_ventana, char *texto_interior, char *opcion1, char *opcion2, char *opcion3) {
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_simple_three_choices, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&simple_three_choices_opcion_seleccionada, &item_seleccionado,
                                        array_menu_simple_three_choices, texto_ventana);
...
//retorna 0 si ESC
int menu_simple_four_choices(char *texto_ventana, char *texto_interior, char *opcion1, char *opcion2, char *opcion3,
                             char *opcion4) {
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_simple_four_choices, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&simple_four_choices_opcion_seleccionada, &item_seleccionado,
                                        array_menu_simple_four_choices, texto_ventana);
...
//retorna 0 si ESC
int menu_simple_five_choices(char *texto_ventana, char *texto_interior, char *opcion1, char *opcion2, char *opcion3,
                             char *opcion4, char *opcion5) {
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_simple_five_choices, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&simple_five_choices_opcion_seleccionada, &item_seleccionado,
                                        array_menu_simple_five_choices, texto_ventana);
...
int menu_simple_six_choices(char *texto_ventana, char *texto_interior, char *opcion1, char *opcion2, char *opcion3,
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_simple_six_choices, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&simple_six_choices_opcion_seleccionada, &item_seleccionado,
                                        array_menu_simple_six_choices, texto_ventana);
...
int menu_simple_seven_choices(char *texto_ventana, char *texto_interior, char *opcion1, char *opcion2, char *opcion3,
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_simple_seven_choices, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&simple_seven_choices_opcion_seleccionada, &item_seleccionado,
                                        array_menu_simple_seven_choices, texto_ventana);
...
int menu_simple_eight_choices(char *texto_ventana, char *texto_interior, char *opcion1, char *opcion2, char *opcion3,
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_simple_eight_choices, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&simple_eight_choices_opcion_seleccionada, &item_seleccionado,
                                        array_menu_simple_eight_choices, texto_ventana);
...
int menu_simple_nine_choices(char *texto_ventana, char *texto_interior, char *opcion1, char *opcion2, char *opcion3,
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_simple_nine_choices, MENU_OPCION_SEPARADOR, NULL, NULL,
                                          texto_interior);
        ...
        retorno_menu = menu_dibuja_menu(&simple_nine_choices_opcion_seleccionada, &item_seleccionado,
                                        array_menu_simple_nine_choices, texto_ventana);
...
int menu_ask_list_texto(char *texto_ventana, char *texto_interior, char *entradas_lista[]) {
    ...
    do {
        ...
        retorno_menu = menu_dibuja_menu(&ask_list_texto_opcion_seleccionada, &item_seleccionado, array_menu_ask_list,
                                        texto_ventana);
...
void zxvision_menu_generic_message_setting(char *titulo, const char *texto, char *texto_opcion, int *valor_opcion) {
    ...
    *valor_opcion = 1;
    ...
    do {
        ...
        menu_add_item_menu_inicial_format(&array_menu_generic_message_setting, MENU_OPCION_NORMAL, NULL, NULL,
                                          buffer_texto_opcion);
        ...
        retorno_menu = menu_dibuja_menu(&array_menu_generic_message_setting_opcion_seleccionada, &item_seleccionado,
                                        array_menu_generic_message_setting, titulo);
        ...
        if (ventana.cursor_line != 0) {
            ...
            if (tecla == 13) {
                ...
                if (cursor_historial >= 0 && cursor_historial < lineas_historial) {
                    ...
                    debug_printf(VERBOSE_DEBUG,
                                 "Trying to set history line %d which does not exist, this should not happen!",
                                 cursor_historial);
                }
            }
...
void menu_ventana_scanf_number_print_buttons(zxvision_window *ventana, char *texto, int x_boton_menos, int x_boton_mas,
                                             int x_texto_input, int x_boton_ok, int x_boton_cancel) {
    //Borrar linea entera
...
int menu_ventana_scanf_numero(char *titulo, char *texto, int max_length, int incremento, int minimo, int maximo,
                              int circular) {
    ...
    do {
        ...
        if (debe_ajustar_cursor_segun_mouse) {
            ...
            int opcion_sel = menu_ventana_scanf_number_ajust_cursor_mouse(array_menu_common, menu_mouse_x,
                                                                          menu_mouse_y - 1);
        ...
        if ((item_seleccionado.tipo_opcion & MENU_OPCION_ESC) == 0 && retorno_menu >= 0) {
            ...
            if (comun_opcion_seleccionada == 1) {
             ...
             !salir_todos_menus && comun_opcion_seleccionada < 3);
...
//Retorna -1 si pulsado ESC
int
menu_ventana_scanf_numero_enhanced(char *titulo, int *variable, int max_length, int incremento, int minimo, int maximo,
                                   int circular) {
...
void menu_inicio_handle_right_button_background(void) {
    ...
    if (menu_pressed_zxdesktop_right_button_background >= 0) {
        ...
        int opcion = menu_simple_five_choices("ZX Desktop", "--Action--", "New icon", "New file link",
                                              "Customize icons", "Reorder icons", "ZX Desktop settings");
...
void menu_inicio_handle_button_pressed_set_next_menu_position(int cual_boton) {
    ...
    int alto_texto = menu_char_height * menu_gui_zoom * zoom_y;
    y = (alto_boton /
         alto_texto); //antes sumaba +1, porque? de esa manera quedaba 1 linea de separación con los botones...
        ...
        if (which_window_clicked_on_background != NULL) {
            ...
            if (geometry_name[0] != 0) {
                ...
                if (indice < 0) {
                    ...
                    if (menu_pressed_open_menu_while_in_menu.v == 0 && !clicked_on_background_windows &&
                        menu_window_manager_window_went_background) {
                        reopen_menu = 0;
                        debug_printf(VERBOSE_INFO,
                                     "From window manager, window goes to background, background windows is allowed even when menu closed, so closing menu");
                    }
...
void menu_inicio(void) {
    ...
    if (zxvision_switch_to_window_on_open_menu) {
        ...
        if (!menu_allow_background_windows || !menu_multitarea) {
            ...
            indice_abrir_ventana_sin_multitarea = zxvision_find_known_window(
            ...
            zxvision_window *ventana_abrir = zxvision_find_window_in_background(
                    zxvision_switch_to_window_on_open_menu_name);
    ...
    if (mouse_left) {
        ...
        if (!pulsado_alguna_ventana_con_menu_cerrado) {
            if (zxvision_if_mouse_in_zlogo_or_buttons_desktop()) {
                debug_printf(VERBOSE_DEBUG,
                             "Pressed in a button from menu_inicio. Mouse is dragging: %d mouse_movido: %d",
    ...
    if (zesarux_has_been_downgraded.v) {
        ...
        if (save_configuration_file_on_exit.v == 0) {
            ...
            if (!valor_opcion) {
                ...
                menu_generic_message_format("Disabled save settings",
                                            "Ok. Current configuration settings will NOT be saved on exit");
            }
        }
    ...
    if (menu_button_osdkeyboard.v) {
        ...
        */
        ...
        if (menu_event_new_version_show_changes.v) {
            ...
            menu_generic_message_format("Updated version",
                                        "You have updated ZEsarUX :)\nPlease take a look at the changes:");
        ...
        if (menu_event_new_update.v) {
            ...
            menu_generic_message_format("New version available", "ZEsarUX version %s is available on github",
                                        stats_last_remote_version);
...
/*
	...
	*/
    ...
    if (paso == 3) {
        if (si_complete_video_driver()) {
            set_splash_zesarux_franja_color(x_inicial + ancho_z * 2 - 1, y_inicial + ancho_z * 2 - 3, color_fondo,
                                            color_verde);
        }
        return;
    }
...
void show_all_windows_startup(void) {
    if (menu_allow_background_windows && menu_multitarea && menu_reopen_background_windows_on_start.v &&
        always_force_overlay_visible_when_menu_closed) {
...
void menu_first_aid_init(void) {
    ...
    //Items que se disparan en ciertos eventos, con parametro si_startup=0
    menu_first_aid_add("filesel_uppercase_keys", &first_aid_no_filesel_uppercase_keys,
                       first_aid_string_filesel_uppercase_keys, 0);
    ...
    menu_first_aid_add("realjoystick_detected", &first_aid_no_realjoystick_detected,
                       first_aid_string_realjoystick_detected, 0);
    menu_first_aid_add("sg1000_boot", &first_aid_no_sg1000_boot, first_aid_string_sg1000_boot, 0);
    menu_first_aid_add("tbblue_download_sd_bug", &first_aid_no_tbblue_download_sd_bugs,
                       first_aid_string_tbblue_download_sd_bugs, 0);
    menu_first_aid_add("mount_mmc_fileutils", &first_aid_no_mount_mmc_fileutils, first_aid_string_mount_mmc_fileutils,
                       0);
    menu_first_aid_add("download_spectrumcomputing", &first_aid_no_download_spectrumcomputing,
                       first_aid_string_download_spectrumcomputing, 0);
    ...
    menu_first_aid_add("hilow_convert_bside", &first_aid_no_hilow_convert_bside, first_aid_string_hilow_convert_bside,
                       0);
    ...
    menu_first_aid_add("zxdesktopcustombuttons", &first_aid_no_zxdesktop_custombuttons,
                       first_aid_string_zxdesktop_custombuttons, 1);
...
void menu_first_aid_random_startup(void) {
    ...
    if (string_config_key_aid_startup != NULL)
...
void menu_ext_desk_settings_width_enlarge_reduce(int enlarge_reduce) {
    ...
    if (enlarge_reduce) {
        ...
        if (zxdesktop_width >= ZXDESKTOP_MAX_WIDTH_MENU_FIXED_INCREMENTS &&
            zxdesktop_width < ZXDESKTOP_MAX_WIDTH_MENU_LIMIT)
            zxdesktop_width = ZXDESKTOP_MAX_WIDTH_MENU_LIMIT;
...
void menu_ext_desk_settings_height_enlarge_reduce(int enlarge_reduce) {
    ...
    if (enlarge_reduce) {
        ...
        //Si esta entre cierto limite (1280..2560 a la fecha de escribir este comentario), saltar a 1280
        if (zxdesktop_height > ZXDESKTOP_MAX_HEIGHT_MENU_FIXED_INCREMENTS &&
            zxdesktop_height <= ZXDESKTOP_MAX_HEIGHT_MENU_LIMIT) {
...
void menu_adjust_gui_style_to_driver(void) {
    ...
    for (i = 0; i < ESTILOS_GUI; i++) {
        ...
        if (definiciones_estilos_gui[i].require_complete_video_driver == 0) {
            debug_printf(VERBOSE_INFO,
                         "Altering GUI style from %s to %s because current video driver does not allow it",
