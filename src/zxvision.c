...
char *first_aid_string_language="Warning: not all messages are translated. Aviso: No todos los mensajes están traducidos. Avís: No tots els missages estan traduits";
