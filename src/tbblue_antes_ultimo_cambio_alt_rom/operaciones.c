  ...
  */
		...
		if (escribir) {
            ...
            altrompointer=tbblue_get_altrom_dir(dir);
                        ...
                        //si los dos bits de lock son cero, ignorar esto
            if (0/* (tbblue_registers[0x8c] & 16)==0  && (tbblue_registers[0x8c] & 32)==0*/ ) {
                printf("Ignoring altrom. writing to normal rom instead?\n");
