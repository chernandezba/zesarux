...
//Este driver parece que no se comporta bien con el cambio de volumen con monitor externo conectado por displayport:
//Al abrir ZEsarUX, el volumen permanece inalterable, aunque lo cambie con el mando a distancia o con los botones del monitor
//Es mas, si tengo un firefox abierto con youtube, el volumen tampoco cambia en youtube
//Parece que viene desde macOS 26.6.2
