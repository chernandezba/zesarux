...
extern void debug_view_basic_from_memory(char *results_buffer,int dir_inicio_linea,int final_basic,char **dir_tokens,int inicio_tokens,z80_byte (*lee_byte_function)(z80_int dir) , int tipo, int show_address, int show_current_line,int mostrar_betabasic,int maximo_guardar,int si_mostrar_aviso_limite );
...
extern void cpu_history_legacy_get_registers_element(int indice,char *string_destino);
extern void cpu_history_get_registers_extended_element(int indice,char *string_destino);
...
extern int cpu_history_find_pc(int direccion_to_find,int max_elements_to_find);
...
extern int debug_view_basic_variables_get_length_variables(void);
