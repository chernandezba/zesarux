...
void customconfig_help(void)
{
	printf ("Custom config help:\n"
        ...
        ".config and .postconfig files are almost the same, can have the same settings, but settings like --poke only have sense \n"
        "on .postconfig files\n"
		"There are some .config and .postconfig files included in the ZEsarUX extras package, you can view them to have some examples."
		"\n"
