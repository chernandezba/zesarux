...
/*
void tape_write_pzx_header_ptr(FILE *ptr_archivo, int in_fatfs, FIL *fil_tzxfile)
{

    int longitud_created=strlen(pzx_file_header_additional)+1; //Contar byte 0 tambien

    //Y contar los 2 bytes que indican la version
    int longitud_bloque=longitud_created+2;
    
    pzx_file_header[4]=value_16_to_8l(longitud_bloque);
    pzx_file_header[5]=value_16_to_8h(longitud_bloque);

    //Primer trozo de la cabecera
    zvfs_fwrite(in_fatfs,pzx_file_header,sizeof(pzx_file_header),ptr_archivo,fil_tzxfile);

	//Segundo con el texto
    zvfs_fwrite(in_fatfs,(z80_byte *)pzx_file_header_additional,longitud_created,ptr_archivo,fil_tzxfile);
    ...
    int nuevo_puntero_lectura=0;
        ...
        if (tzxfile!=NULL) {
            ...
            if (es_pzx) {
                ...
                tape_write_pzx_header_ptr(ptr_tzxfile);
            }
            else {
                ...
                if (longitud_final>=0) {
                        ...
                        //Convertir a tzx o pzx
                            ...
                            if (es_pzx) {
                                ...
                                tape_block_pzx_begin_save_ptr(ptr_tzxfile,longitud_bloque_pzx,flag_bloque);
