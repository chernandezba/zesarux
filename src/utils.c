...
int array_maquinas_microdigital_electronica[]={
	MACHINE_ID_MICRODIGITAL_TK80,MACHINE_ID_MICRODIGITAL_TK85,MACHINE_ID_MICRODIGITAL_TK90X,MACHINE_ID_MICRODIGITAL_TK90X_SPA,MACHINE_ID_MICRODIGITAL_TK95,MACHINE_ID_MICRODIGITAL_TK95_SPA,255
};
