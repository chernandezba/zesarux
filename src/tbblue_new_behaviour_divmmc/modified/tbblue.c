...
void tbblue_set_emulator_setting_divmmc(void)
{
    ...
    if (diven) {
        ...
        printf ("Desactivando diviface automatic paging mediante llamada tbblue\n");
...
/*
		...
		case 6:
			...
			if ( (last_register_6&16) != (value&16)) {
                //printf("Cambio divmmc por registro 6\n");
                //ya no deberia ser esto
                //antes era: bit 4 = Enable divmmc automap and divmmc nmi by DRIVE button (hard reset = 0)
                //tbblue_set_emulator_setting_divmmc();
                /*
