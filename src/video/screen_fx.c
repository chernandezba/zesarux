...
screen_effect_type_name screen_effect_type_list[MAX_SCREEN_EFFECTS]={
    ...
    {SCREEN_EFFECT_TYPE_SHEAR,"Shear","Cizalla","Cisalla",&screen_rainbow_effect_shear_intensity_follow_mouse,&screen_rainbow_effect_shear_intensity,SCREEN_FX_SHEAR_DEFAULT_INTENSITY,1,49},
    ...
    {SCREEN_EFFECT_TYPE_ZOOM,"Zoom","Zoom","Zoom",NULL,&screen_rainbow_effect_zoom_factor,SCREEN_FX_ZOOM_DEFAULT_FACTOR,SCREEN_FX_ZOOM_DEFAULT_FACTOR,SCREEN_FX_ZOOM_MAX_FACTOR},
    ...
    {SCREEN_EFFECT_TYPE_FADEOUT,"Fade Out","Fade Out","Fade Out",NULL,NULL,0,0,0},
    {SCREEN_EFFECT_TYPE_FADEINOUT,"Fade InOut","Fade InOut","Fade InOut",NULL,NULL,0,0,0},
    ...
    {SCREEN_EFFECT_TYPE_BRIGHTNESS,"Brightness","Brillo","Brillantor",&screen_rainbow_effect_brightness_follow_mouse,&screen_rainbow_effect_brightness_intensity,SCREEN_FX_BRIGHTNESS_DEFAULT_INTENSITY,0,256*100},
    {SCREEN_EFFECT_TYPE_NAGRAVISION,"Nagravision","Nagravision","Nagravision",NULL,NULL,0,0,0},
...
void screen_rainbow_effect_zoom(z80_int *origen,z80_int *destino,int ancho,int alto)
{
    ...
    for (y=0;y<alto;y++) {
        for (x=0;x<ancho;x++) {
            int x_orig=(x*10)/screen_rainbow_effect_zoom_factor;
            int y_orig=(y*10)/screen_rainbow_effect_zoom_factor;
...
void screen_rainbow_effect_rgb_params(z80_int *origen,z80_int *destino,int ancho,int alto,int bit_r,int bit_g,int bit_b)
{
    ...
    for (y=0;y<alto;y++) {
        for (x=0;x<ancho;x++) {
            ...
            if (bit_r) red=valor_gris;
            else red=0;

            if (bit_g) green=valor_gris;
            else green=0;

            if (bit_b) blue=valor_gris;
            else blue=0;
...
{
    screen_rainbow_effect_rgb_params(origen,destino,ancho,alto,screen_rainbow_effect_rgb_red.v,screen_rainbow_effect_rgb_green.v,screen_rainbow_effect_rgb_blue.v);
}

void screen_rainbow_effect_red(z80_int *origen,z80_int *destino,int ancho,int alto)
{
    screen_rainbow_effect_rgb_params(origen,destino,ancho,alto,1,0,0);
}
...
void screen_rainbow_effect_shaderborder_lateral(z80_int *origen,z80_int *destino,int ancho,int alto)
{
    ...
    screen_rainbow_effect_shaderborder_copy(origen,temp_bufferdestino,ancho,alto,screen_rainbow_effect_shaderborder_factor_zoom_leftright,1000,
        ...
        ancho_borde_izquierdo+(screen_rainbow_effect_shaderborder_ancho_pantalla-ancho_borde_derecho*screen_rainbow_effect_shaderborder_factor_zoom_leftright/1000),alto_border_superior, //origen
        ancho_borde_izquierdo+screen_rainbow_effect_shaderborder_ancho_pantalla,alto_border_superior  //destino
    );
    ...
    //y en el derecho
    screen_rainbow_effect_blur_zone(temp_bufferdestino,destino,ancho_borde_izquierdo+screen_rainbow_effect_shaderborder_ancho_pantalla,alto_border_superior,ancho_borde_derecho,screen_rainbow_effect_shaderborder_alto_pantalla,
        ancho,alto,screen_rainbow_effect_shaderborder_blur_intensity_leftright,0);
        ...
        if (screen_effect_applied_list[i].enabled && screen_effect_applied_list[i].type!=SCREEN_EFFECT_TYPE_NONE) {
            ...
            switch (screen_effect_applied_list[i].type) {
                ...
                case SCREEN_EFFECT_TYPE_RED:
                    screen_rainbow_effect_red(origen,destino,ancho,alto);
                break;
