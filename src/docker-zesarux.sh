...
case $1 in
	...
	push)
		docker build -f Dockerfile.pushimage .  --progress plain --tag=chernandezba/zesarux:12.0

  		#docker tag zesarux.local chernandezba/zesarux:12.0
		docker push chernandezba/zesarux:12.0
	;;
