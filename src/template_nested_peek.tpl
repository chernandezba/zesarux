...
z80_byte (*NOMBRE_FUNCION_no_nested) (z80_int dir);
...
z80_byte NOMBRE_FUNCION_nested_handler(z80_int dir)
{
	return debug_nested_generic_handler(nested_list_NOMBRE_FUNCION,dir,0);
}
...
void debug_nested_NOMBRE_FUNCION_del(int id)
{
	...
	if (nested_list_NOMBRE_FUNCION==NULL) {
		...
		debug_printf (VERBOSE_DEBUG,"NOMBRE_FUNCION nested empty. Assign normal NOMBRE_FUNCION");
...
z80_byte debug_nested_NOMBRE_FUNCION_call_previous(int id,z80_int dir)
{
	...
	if (nested_list_NOMBRE_FUNCION->next==NULL) {
		...
		return NOMBRE_FUNCION_no_nested(dir);
	}
